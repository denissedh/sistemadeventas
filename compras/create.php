                                   ...
                                   <script>
                                       $('#btn_guardar_compra').click(function () {
                                           ...
                                           if(id_producto == ""){
                                               ...
                                               $.get(url,{id_producto:id_producto,nro_compra:nro_compra,fecha_compra:fecha_compra,id_proveedor:id_proveedor,comprobante:comprobante,id_usuarios:id_usuarios,precio_compra:precio_compra,cantidad:cantidad,stock_total:stock_total},function (datos) {
