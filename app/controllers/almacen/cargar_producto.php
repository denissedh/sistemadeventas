...
$sql_productos = "SELECT *, cat.nombre_categoria as categoria, u.email as email, u.id_usuarios as id_usuarios
                  FROM tb_almacen as a INNER JOIN tb_categorias as cat ON a.id_categoria = cat.id_categoria 
                  INNER JOIN tb_usuarios as u ON u.id_usuarios = a.id_usuarios WHERE id_producto = '$id_producto_get'";
