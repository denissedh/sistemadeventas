...
if (isset($_GET['id'])) {
    ...
    $sql_compras = "SELECT *, co.precio_compra as precio_compra, co.cantidad as cantidad,
    ...
    prov.empresa as empresa, prov.email as email_proveedor, prov.direccion as direccion_proveedor, us.nombres as nombres_usuarios 
    ...
    INNER JOIN tb_usuarios as us ON co.id_usuarios = us.id_usuarios 
    ...
    foreach ($compras_datos as $compras_dato){
        ...
        $nombres_usuarios = $compras_dato['nombres_usuarios'];
    }
} else {
    // Si no hay ID, inicializa las variables vacías para evitar errores en la vista
    $compras_datos = [];
    $nro_compra = "No especificado";
}