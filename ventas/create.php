                        ...
                        <div class="card-body">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <script>
                                                                        $('#btn_seleccionar<?php echo $id_producto; ?>').click(function () {
                                                                            var id_producto = "<?php echo addslashes($id_producto); ?>";
                                                                            $('#id_producto').val(id_producto);
                                                                            var producto = "<?php echo addslashes($productos_dato['nombre']); ?>";
                                                                            $('#producto').val(producto);
                                                                            var descripcion = "<?php echo addslashes($productos_dato['descripcion']); ?>";
                                                                            $('#descripcion').val(descripcion);
                                                                            var precio_venta = "<?php echo addslashes($productos_dato['precio_venta']); ?>";
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-sm table-hover table-striped">
                                    ...
                                    $nro_ventas = $contador_de_ventas + 1;
                                    ...
                                    pro.id_producto as id_producto FROM  tb_carrito AS carr INNER JOIN tb_almacen as pro ON carr.id_producto = pro.id_producto
                                     WHERE nro_venta = '$nro_ventas' ORDER BY id_carrito ASC";
                                                                ...
                                                                <center>
                                                                    ...
                                                                    <script>
                                                                        $('#btn_pasar_cliente<?php echo $id_cliente; ?>').click(function(){
                                                                            var id_cliente = '<?php echo addslashes($clientes_dato['id_cliente']); ?>';
                                                                            $('#id_cliente').val(id_cliente);

                                                                            var nombre_cliente = '<?php echo addslashes($clientes_dato['nombre_cliente']); ?>';
                                                                            $('#nombre_cliente').val(nombre_cliente);

                                                                            var nit_ci_cliente = '<?php echo addslashes($clientes_dato['nit_ci_cliente']); ?>';
                                                                            $('#nit_ci_cliente').val(nit_ci_cliente);

                                                                            var celular_cliente = '<?php echo addslashes($clientes_dato['celular_cliente']); ?>';
                                                                            $('#celular_cliente').val(celular_cliente);

                                                                            var email_cliente = '<?php echo addslashes($clientes_dato['email_cliente']); ?>';
                                    ...
                                    $('#btn_guardar_venta').click(function () {
                                        ...
                                        function actualizar_stock() {
                                            ...
                                            for ( i = 1; i <= n ; i++){
                                                ...
                                                var c = '#id_producto'+i;
                                                var id_ptoducto = $(c).val();

                                                var stock_calculado = parseFloat(stock_de_inventario - cantidad_carrito);

                                                // alert(id_ptoducto+" - "+stock_de_inventario +" - "+ cantidad_carrito +" - "+stock_calculado);

                                                var url2 = "../app/controllers/ventas/actualizar_stock.php";
                                                $.get(url2, {id_ptoducto:id_ptoducto, stock_calculado:stock_calculado}, function (datos) {
                                                });
                                            }
                                        }
